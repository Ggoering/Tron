...
var bike1 = new Image()
bike1.src = './lib/game/assets/p1_bike_vert.png';
bike1.xpos = player1.xpos
bike1.ypos = player1.ypos
...
function reset() {
  player1 = new Player(grid.x + 200, grid.y + 200, 10, 10, "#FF6663")
}
...
requestAnimationFrame(function gameloop() {
  ...
  if (!game.roundOver) {
    ...
    player1.moveTrail()
    player1.moveHead(bike1);
    // player2.moveHead();

    player1.drawBike(context, bike1)
