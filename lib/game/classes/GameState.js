...
class GameState {
  ...
  setupEnvironment() {
    ...
    this.grid.x + 80,
    this.grid.y + this.grid.height * 0.8,
    'red',
    this.velocity,
    'Player 1',
    'p1',
    ...
    this.grid.x + this.grid.width - 80,
    this.grid.y + this.grid.height * 0.2,
    'blue',
    this.velocity,
    'Player 2',
    'p2',
  ...
  saveDeadZones() {
    ...
    this.wipDeadZone.push(
    this.grid.x + floorCoordX * this.grid.width / this.grid.lines,
    this.grid.y + floorCoordY * this.grid.height / this.grid.lines)
  }
