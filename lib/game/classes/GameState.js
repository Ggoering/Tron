...
class GameState {
  ...
  setupEnvironment() {
    ...
    this.player1 = new Player(
      this.grid.x, this.grid.y + this.grid.height * 0.8, 'red', this.velocity, 'Player 1', 'p1')
    this.player2 = new Player(this.grid.x, this.grid.y + this.grid.height * 0.2, 'blue', this.velocity, 'Player 2', 'p2')
  }
